...
static inline int gethostname_stub(char *name, size_t namelen) {strlcpy(name, "esp8266", namelen); return 0; }
...
static inline int kill_stub() { errno = ENOSYS; return -1; }
#define kill(p, s) kill_stub()
